...
NOTE: this module may not be needed later,
      for now FunctionCaller class seems
      to be usable as-is.
"""
...
class FunctionCaller:
    ...
    """
    def __init__(self, func, domain, opt_pt=None, opt_val=None,
                noise_type='none', noise_params=None, descr=''):
        """ Constructor.
    ...
    def eval_single(self, x, qinfo=None, noisy=True):
        """ Evaluates func at a single point x. If noisy is True and 
            noise_type is None, will add noise.
        """
